...
import com.appmatrixinc.amauto.R;
...
public class CaldroidFragment extends DialogFragment {
    ...
    public static int selectedBackgroundDrawable = R.color.calendar_lightBlue;
		...
		if (dateItemClickListener == null) {
			dateItemClickListener = new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    com.roomorama.caldroid.SquareTextView cellView = (com.roomorama.caldroid.SquareTextView) getActivity().findViewById(R.layout.date_cell);
					...
					if (caldroidListener != null) {
                        ...
                        parent.getChildAt(position).setBackgroundColor(getActivity().getResources().getColor(R.color.calendar_lightBlue));
                        if(save != -1 && save != position) {
                            parent.getChildAt(save).setBackgroundColor(getActivity().getResources().getColor(R.color.calendar_darkBlue));
                        }
                        save = position;
					}
				}
